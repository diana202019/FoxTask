...
//        );
        ...
        ProjectedCube projectedOriginCube = new ProjectedCube(cube.project());
//        projectedOriginCube.paint(g);

        ProjectedCube projectedCubeRotated = new ProjectedCube(rotated.project());
