...
public class State2 implements State {
    ...
    public void setBodyPosition(LinkedList<Line2D> bodyShapes) {
        ...
        bodyShapes.get(0).setLine(newP0.getX(), newP0.getY(), newP1.getX() + 3, newP1.getY());
        bodyShapes.get(1).setLine(newP1.getX() + 3, newP1.getY(), newP2.getX() + 6, newP2.getY());
        bodyShapes.get(2).setLine(newP2.getX() + 6, newP2.getY(), newP3.getX() + 6, newP3.getY() - 1);
        bodyShapes.get(4).setLine(newP4.getX(), newP4.getY(), newP5.getX() + 3, newP5.getY());
        bodyShapes.get(5).setLine(newP5.getX() + 3, newP5.getY(), newP6.getX() + 3, newP6.getY());

        automata.setCurrentState(new State3(automata));
    }
}
