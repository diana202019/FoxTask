...
public class State7 implements State {
    ...
    public State7(Automata automata) {
    ...
    public void setBodyPosition(LinkedList<Line2D> bodyShapes) {
        ...
        bodyShapes.get(0).setLine(newP0.getX(), newP0.getY(), newP1.getX() - 4, newP1.getY());
        bodyShapes.get(1).setLine(newP1.getX() - 4, newP1.getY(), newP2.getX() - 7, newP2.getY());
        bodyShapes.get(2).setLine(newP2.getX() - 7, newP2.getY(), newP3.getX() - 7, newP3.getY() + 1);
        bodyShapes.get(4).setLine(newP4.getX(), newP4.getY(), newP5.getX() - 4, newP5.getY());
        bodyShapes.get(5).setLine(newP5.getX() - 4, newP5.getY(), newP6.getX() - 4, newP6.getY());

        automata.setCurrentState(new State1(automata));
    }
}
